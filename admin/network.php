                ...
                <ul class="nav nav-tabs nav-overflow header-tabs">
                  <li class="nav-item">
                    <a href="#!" class="nav-link text-nowrap active">
                      Active <span class="badge rounded-pill bg-secondary-soft">823</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#!" class="nav-link text-nowrap">
                      Inactive <span class="badge rounded-pill bg-secondary-soft">231</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#!" class="nav-link text-nowrap">
                      Suspended <span class="badge rounded-pill bg-secondary-soft">22</span>
                    </a>
                  </li>
                </ul>
