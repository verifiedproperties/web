        ...
        <div class="col-12">
          <?php
            if ($accounts_pending >= 1) {
              echo "<div class='alert alert-warning text-white'><i class='fe fe-users'></i> There are <a href='pending-accounts' class='text-white'>$accounts_pending</a> account(s) pending activation!</div>";
            }
          ?>
        </div>
      </div>
